...
\crefalias{sublstfloat}{listing}
\lstset{
  basicstyle=\ttfamily,
}
\makeatletter
\def\sidewayslstfloat{\@rotfloat{lstfloat}}
\let\endsidewayslstfloat\end@rotfloat
\makeatother
...
\newcommand{\wikidataRevision}[1]{\gls{Wikidata} revision \href{https://www.wikidata.org/wiki/Special:Diff/#1}{#1}}
