...
In RDF, information is arranged in subject-predicate-object triples,
...
This graph can then be queried using the SPARQL % TODO acronym
query language \cite{9569543}. % TODO is SPARQL really important enough to be mentioned here, and nothing else?
...
and export it as a ShEx % TODO glossary
