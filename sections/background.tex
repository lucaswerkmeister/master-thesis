...
\Cref{fig:montblanc} shows two screenshots of the same Wikidata item,
...
identified by a URI like \url{http://example.com/Alan_Turing} or \url{http://www.wikidata.org/entity/Q5}, % TODO acronym? URLs vs URIs vs IRIs?
...
\begin{description}
\item[\PName{wd:}] A Wikidata entity (usually an item, like \PName{wd:Q7251}).
\item[\PName{wdt:}] Predicate for a triple representing a Wikidata statement, e.~g. \PName{wdt:P31}.
...
\item[\PName{ex:}] An example entity.
  Following the naming conventions of schema.org, % TODO cite https://schema.org/docs/old_extension.html ? I couldn’t find a better source
...
For example, many graphs use the same predicate, \PName{rdfs:label},
