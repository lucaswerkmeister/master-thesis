...
\end{sublisting}
\caption[Simplification step 2]{Simplification step 2 (in \acrshort{shexc}-like pseudo-syntax)}
...
\end{sublisting}
\caption[Simplification step 3]{Simplification step 3 (in \acrshort{shexc}-like pseudo-syntax)}
...
\end{sublisting}
\caption[Simplification step 4]{Simplification step 4 (in \acrshort{shexc}-like pseudo-syntax)}
