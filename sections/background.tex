...
X {
  ...
  \end{subfigure}
  \caption[The first simplification step.]{The first simplification step (in pseudo-syntax).}
...
X {
  ...
  \end{subfigure}
  \caption[The second simplification step.]{The second simplification step (in pseudo-syntax).}
...
X {
  ...
  \end{subfigure}
  \caption[The third simplification step.]{The third simplification step (in pseudo-syntax).}
...
X {
  ...
  \end{subfigure}
  \caption[The first simplification step, with class relations.]{
