...
This graph can then be queried using the \acrfull{sparql} \cite{9569543}. % TODO is SPARQL really important enough to be mentioned here, and nothing else?
...
The simplest \gls{rdf} syntax is N-Triples, % TODO glossary?
...
The N-Triples representation of the same graph as in \cref{fig:rdf-example}
is presented in \cref{lst:rdf-example};
since N-Triples does not allow the use of prefixes to abbreviate \glspl{iri},
