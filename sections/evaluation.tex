...
to get more reliable execution times. % TODO mention my hardware? at least the CPU and amount of RAM?
...
a job for \num{20000} mammals, with reasonable execution time compared to an absurd number of selected entities, % TODO “absurd” okay?
and a job for humans with most sitelinks, with unusually high execution time compared to the amount of input data. % TODO find better justification for this outlier.
