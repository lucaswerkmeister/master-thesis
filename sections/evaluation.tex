...
one starts with a basic \gls{shape} for the input entities
...
However, the data from the \gls{wdsi}
...
as well as the number of entities indirectly selected as the values of \glspl{statement} on the original entities (and their size).
...
number of entities, number of \glspl{triple}, number of \PName{wdt:P31} \glspl{triple}, number of distinct classes –
