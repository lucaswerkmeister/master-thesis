...
may result in a concise summary of the current \gls{schema} of those \glspl{item} % TODO “concise” is not really the right word…
...
This was then made available to the whole \gls{Wikidata} community % TODO kinda mixing tenses here
