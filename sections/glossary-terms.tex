...
% these are better known in their short form anyways…
\glsunset{sparql}
\glsunset{url}
\glsunset{html}
\glsunset{css}
...
\glsunset{json}
\glsunset{json-ld}
% …and these are introduced explicitly in the Background and I don’t want the first use to occur earlier
\glsunset{rdf}
\glsunset{shex}
...
\newglossaryentry{alias}{
  name=Alias,
  plural=Aliases,
  description={additional term by which an \gls{item} or \gls{property} should be found},
}
...
\newglossaryentry{vocabulary}{
  name=vocabulary,
  plural=vocabularies,
  description={set of \glspl{resource} useful in combination, often sharing a common \gls{prefix}},
}
...
\newglossaryentry{simplification}{
  name=simplification,
  description={optional \gls{RDF2Graph} step to simplify (usually, shorten) an inferred \gls{shex} \gls{schema} by merging references to related classes},
}
...
\newglossaryentry{shex.js}{
  name={shex.js},
  description={\gls{shex} implementation in \gls{JavaScript}},
}
\newglossaryentry{shex-java}{
  name={shex-java},
  description={\gls{shex} implementation in \gls{Java}},
}
...
\newglossaryentry{Java}{
  name=Java,
  description={programming language for portable applications},
}
\newglossaryentry{job}{
  name={job},
