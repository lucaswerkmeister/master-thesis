...
The syntax of the generated ShExC \glspl{schema} % TODO glossary for ShExC?
...
(for example, the 2018-08-20 full \gls{Wikidata} dump is \SI{42.7}{\giga\byte} large after gzip compression % TODO >300GB uncompressed (309657344438 bytes), which is probably more impressive
...
“an \gls{item} has one or more \glspl{label}, zero or more \glspl{description}, and zero or more \glspl{alias}”. % TODO express as ShExC?
...
To mitigate this, \gls{RDF2Graph} was patched % TODO awkward passive voice
...
is unlikely to care that the \gls{item} for the protein’s discoverer’s husband’s country of citizenship % TODO too many ’s?
...
the \gls{wdsi},
which makes the \gls{Wikidata}-aware % “Wikidata-aware”?
