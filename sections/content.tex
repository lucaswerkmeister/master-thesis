...
to run the entire process and generate the ShEx file.
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[every path/.style=arrow, midway]
      ...
      \path (RDF2Graph.south) -- node {ShEx exporter} (ShEx);
...
which is necessary because RDF2Graph, its ShEx exporter, and the Makefile-based process around them
