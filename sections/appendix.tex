...
(data download, initial \gls{RDF2Graph} run, \gls{RDF2Graph} \gls{simplification}, \gls{shex} export)
...
the full data also shows that the \gls{simplification} step of the process
...
(\gls{RDF2Graph} without \gls{simplification} and \gls{shex} export)
anyways.
